    ...
    def rewind_messages(
        ...
        *,
        ...
        if deleted > 0:
            ...
            # Reset summary artifacts to avoid using stale future-branch context.
            self.db.query(SessionSummaryCheckpoint).filter(
                SessionSummaryCheckpoint.session_id == session_obj.session_id
            ).delete(synchronize_session=False)
