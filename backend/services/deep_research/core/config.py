...
class Settings(BaseSettings):
    ...
    REPORT_SECTION_QUICK_PROMPT_MAX_INPUT_TOKENS: int = 9000
    REPORT_SECTION_QUICK_MAX_BLOCKS: int = 7
    REPORT_SECTION_QUICK_MAX_NOTES_PER_BLOCK: int = 4
    REPORT_SECTION_QUICK_MAX_NOTES_TOTAL: int = 28
    REPORT_SECTION_QUICK_MAX_CITATIONS: int = 48
