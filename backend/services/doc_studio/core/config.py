...
class Settings(BaseSettings):
    ...
    # qwen-plus / qwen-turbo 已统一从全局候选移除（产物质量不稳定）。
    # 文本任务用 qwen3-max / qwen-max；视觉走 DASHSCOPE_VISION_MODEL_NAME。
    ...
    # LLM_COST_CONFIG 示例：
    # {
    #   "dashscope": {"qwen3-max": {"input": 0.0, "output": 0.0}, "default": {"input": 0.0, "output": 0.0}},
