"""
Doc Studio Agent 微服务
提供独立的文档工作室服务，支持 Markdown/LaTeX 等多格式编辑与引用管理
"""
...
logger = logging.getLogger("doc_studio_service")
...
app = FastAPI(
    title="Doc Studio Service",
    version="1.0.0",
    description="Doc Studio 微服务，提供多格式文档编辑、引用管理等功能"
)
