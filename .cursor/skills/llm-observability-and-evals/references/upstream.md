...
Prompt governance is one slice of production Agent quality. ScholarMind needs a broader contract that explains why a request behaved the way it did across RAG, tools, model providers, persistence, and frontend state.
