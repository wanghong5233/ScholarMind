...
The upstream skill is comprehensive and proactive, but too long for our always-discovered project skill set. This version keeps only the production Agent cost decisions that repeatedly matter in ScholarMind-like systems.
